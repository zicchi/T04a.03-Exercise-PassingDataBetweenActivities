...
public class ChildActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intentThatStartedThisActivity.hasExtra(Intent.EXTRA_TEXT)) {
            ...
            // TODO (5) If the Intent contains the correct extra, retrieve the text (In todo 4)

            // TODO (6) If the Intent contains the correct extra, use it to set the TextView text(In todo 4)
    }
}